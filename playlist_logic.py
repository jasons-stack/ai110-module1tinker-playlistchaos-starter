...
def classify_song(song: Song, profile: Dict[str, object]) -> str:
    ...
    is_hype_genre = any(keyword in genre for keyword in hype_keywords)
    is_chill_title = any(keyword in title for keyword in chill_keywords)

    is_hype = energy >= hype_min_energy or genre == favorite_genre or is_hype_genre
    is_chill = energy <= chill_max_energy or is_chill_title
